...
/**
 * Load layout from file, resetting to bundled default if its revision is newer.
 */
export function loadLayout(
  ...
  if (fromFile) {
    ...
    if (defaultRevision > fileRevision) {
      if (defaultLayout) writeLayoutToFile(defaultLayout);
...
/**
 * Watch ~/.pixel-agents/layout.json for external changes (other browser windows).
